...
-- TODO figure out how to write this with new busted after busted.lua refactor
pending("Malformed Lua code gets reported correctly", function()
...
pending("finally callback is called in case of success", function()
...
pending("finally callback is called in case of error", function()
  local f = spy.new(function() end)
  busted.run_internal_test(function()
    it("write variable in finally", function()
      finally(f)
...
--TODO: unpending this failing test and fix it
pending("testing done callbacks being provided", function()
  setup(function(done)
